...
int main()
{
	...
	gui::IGUIInOutFader* fader = device->getGUIEnvironment()->addInOutFader();
        fader->setColor(video::SColor(0,200,200,200));
        fader->fadeIn(8000);
...
driver->setTextureCreationFlag(video::ETCF_CREATE_MIP_MAPS, false);
	...
	scene::ISceneNode* skybox=smgr->addSkyBoxSceneNode(
		driver->getTexture("./data/skybox/shadowpeak_up.jpg"),
		driver->getTexture("./data/skybox/shadowpeak_dn.jpg"),
		driver->getTexture("./data/skybox/shadowpeak_rt.jpg"),
		driver->getTexture("./data/skybox/shadowpeak_lf.jpg"),
		driver->getTexture("./data/skybox/shadowpeak_ft.jpg"),
		driver->getTexture("./data/skybox/shadowpeak_bk.jpg"));
	
	driver->setTextureCreationFlag(video::ETCF_CREATE_MIP_MAPS, true);


// loading d3s scene(Mesh)
	scene::ISceneNode* test_scene = smgr->addOctTreeSceneNode(smgr->getMesh("./data/3ds/final.3ds"));
	...
	// Message 
	wchar_t *caption = L"Demo1. Depth Of Field - One tree.";
	wchar_t *text = 
		L"Depth Of Field\n\n"
